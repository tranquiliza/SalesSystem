...
namespace Tranquiliza.Shop.Core.Model
{
    public class Product : DomainEntityBase
    {
        ...
        private Product(string name, string category, double price, string description)
        {
        ...
        public void Update(string name, string category, string description, double purchaseCost, double price, double weight, bool isActive)
        {
        ...
        public static Product Create(string title, string category, double price, string description) => new Product(title, category, price, description);
